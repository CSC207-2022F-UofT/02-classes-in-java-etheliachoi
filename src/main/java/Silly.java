...
public class Silly implements Comparable<Silly>{
    ...
    /** Creates a Silly object. This constructor takes in two strings as an argument.
     *
     * @param first a String for the first half of this Silly instance's name.
     * @param second a String for the second half of this Silly instance's name.
     */
